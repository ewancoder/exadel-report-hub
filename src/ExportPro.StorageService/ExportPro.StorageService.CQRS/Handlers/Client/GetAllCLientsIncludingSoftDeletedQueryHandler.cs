...
public class GetAllCLientsIncludingSoftDeletedQueryHandler(IClientRepository clientRepository)
    : IQueryHandler<GetAllCLientsIncludingSoftDeletedQuery, List<ClientResponse>>
{
    IClientRepository _clientRepository = clientRepository;

    public async Task<BaseResponse<List<ClientResponse>>> Handle(
        GetAllCLientsIncludingSoftDeletedQuery request,
