...
//public class clientRepository(IMapper mapper,IClientRepository clientRepository,IInvoiceRepository invoiceRepository,CustomerRepository customerRepository):IclientRepository
//{
//    private readonly IClientRepository _clientRepository= clientRepository;
//    private readonly IInvoiceRepository _invoiceRepository=invoiceRepository;
//    private readonly CustomerRepository _customerRepository=customerRepository;
//    private readonly IMapper _mapper = mapper;  
//    public async Task<List<ClientResponse>> GetClientsService(int client_size,int page)
//    {
//        var clients = await _clientRepository.GetClients(client_size,page);
...
//    public Task<List<ClientResponse>> GetClientsService()
//    {
