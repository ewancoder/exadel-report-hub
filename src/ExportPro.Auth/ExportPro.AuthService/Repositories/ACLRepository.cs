...
{
    public  Task<List<UserClientRoles>> GetUserClientRolesAsync(ObjectId userId, ObjectId clientId, CancellationToken cancellationToken = default)
    {
        return  Collection
    ...
    public  Task RemoveUserClientRoleAsync(ObjectId userId, ObjectId clientId, CancellationToken cancellationToken = default)
    {
