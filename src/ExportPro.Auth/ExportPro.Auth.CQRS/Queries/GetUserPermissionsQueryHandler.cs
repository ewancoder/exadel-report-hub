...
public class GetUserPermissionsQueryHandler(IACLService aclService) : IQueryHandler<GetUserPermissionsQuery, List<PermissionDTO>>
{
    public async Task<BaseResponse<List<PermissionDTO>>> Handle(GetUserPermissionsQuery request, CancellationToken cancellationToken)
    {
