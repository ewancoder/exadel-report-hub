...
public class GetAllUsersQueryHandler(IHttpContextAccessor httpContextAccessor, IUserRepository userRepository, IACLService aclService) : IQueryHandler<GetAllUsersQuery, List<UserDto>>
{
